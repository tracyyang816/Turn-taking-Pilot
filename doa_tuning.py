...
class Tuning:
    ...
    #     # print(usb.util.CTRL_IN | usb.util.CTRL_TYPE_VENDOR | usb.util.CTRL_RECIPIENT_DEVICE)
    #     # print("debug")
    ...
    #     response = self.dev.ctrl_transfer(192, 0, 0x80, 21, 8, 5000)
    #     # print(len(response))
    #     # response = self.dev.ctrl_transfer(usb.util.CTRL_OUT | usb.util.CTRL_TYPE_VENDOR | usb.util.CTRL_RECIPIENT_DEVICE, 0, cmd, 0x1C, data, self.TIMEOUT)
    ...
    #     length = 8  # Expected response length
    #     try:
    #         response = self.dev.ctrl_transfer( 
    #             usb.util.CTRL_IN | usb.util.CTRL_TYPE_VENDOR | usb.util.CTRL_RECIPIENT_DEVICE,
    #             0, cmd, id, length, self.TIMEOUT)
    ...
    #         response = struct.unpack(b'ii', response.tobytes())  # Debug if this matches the actual response format
    ...
    #         # print(f"USBError while reading {name}: {e}")
    #         return None
...
def find(vid=0x14cd, pid=0x8601):
